...
<div class="container py-5" style="height: 50vh">
    <h2>Website Analytics Checker</h2>
    <form id="analytics-form" action="{{ route('analytics.check') }}" method="POST">
        @csrf
        <div class="form-group">
            <input type="text" name="url" class="form-control" placeholder="Enter website URL" required>
        </div>
        <button type="submit" id="check-btn" class="btn btn-primary">Check Analytics</button>
    </form>
    ...
    <div id="loader" style="display: none; text-align: center; margin-top: 20px;">
        ...
        <p>Checking Website Analytics...</p>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (analyticsForm && checkBtn && loader) {
            analyticsForm.addEventListener('submit', function () {
                checkBtn.disabled = true; // Disable the button
